      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Premium IT & software development for real-world impact.
          </p>
          <p className="text-sm mt-4 text-slate-500">
            From final-year projects to production-ready apps and AI solutions.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2">
              ...
              campuscodelabs@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="w-4 h-4 text-brand-400" /> India
            </li>
          </ul>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-3">
              <a
                aria-label="LinkedIn"
                href="https://www.linkedin.com/company/campus-code-labs/"
